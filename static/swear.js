function validateForm() {
  ...
  for (var i = 0; i < swear_words.length; i++) {
    // Regular expression to check if the word is present in question or answer, with or without spaces and special characters
    var pattern = new RegExp(swear_words[i].split('').join('[\\s\\W]*'), 'gi');
